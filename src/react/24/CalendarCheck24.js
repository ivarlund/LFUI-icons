...
function CalendarCheck24({ title, titleId, ...props }) {
  return (
    <svg width={24} height={24} aria-labelledby={titleId} {...props}>
      ...
      <g fill="currentColor" fillRule="nonzero">
        ...
        <path d="M16.484 11.709l-1.41-1.418-3.914 3.892-1.448-1.48-1.424 1.405 2.858 2.908z" />
      </g>
    </svg>
  );
}

export default CalendarCheck24;
