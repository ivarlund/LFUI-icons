  ...
  return (
    <svg width={32} height={32} aria-labelledby={titleId} {...props}>
      ...
      <g fill="currentColor" fillRule="nonzero">
        ...
        <path d="M24.27 18.35l-1.44 1.388-2.55-2.642 1.44-1.389zM9.139 19.771l-1.44-1.389 1.581-1.638 1.44 1.388z" />
        <path d="M19 19.547v2h-5.148l-5.719-5.77 1.42-1.408 5.133 5.178zM13.444 13.487l-.888-1.792 7.63-3.784 2.361 2.657h3.358l1.952 3.245-1.714 1.03-1.369-2.275h-3.125l-1.943-2.187z" />
        <path d="M16.085 6.145l-1.896.572-.578-1.915 3.138-.947 4.907 5.673-1.512 1.309zM3 13.328h3.983v2H1V9.182h11.071l2.174 3.841-1.74.985-1.6-2.826H3z" />
      </g>
    </svg>
  );
}
