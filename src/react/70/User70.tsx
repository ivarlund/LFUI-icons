    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use
          fill="currentColor"
          fillRule="nonzero"
          xlinkHref="#user-70_svg__a"
          transform="translate(7 6.827)"
        />
      </g>
    </svg>
  );
