...
function NotificationSwish70({ title, titleId, ...props }) {
  return (
    <svg
      width={70}
      height={70}
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use
          fill="currentColor"
          fillRule="nonzero"
          xlinkHref="#notification-swish-70_svg__a"
...
export default NotificationSwish70;
