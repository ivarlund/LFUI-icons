  ...
  return (
    <svg width={40} height={40} aria-labelledby={titleId} {...props}>
      ...
      <g fill="currentColor" fillRule="nonzero">
        <path d="M19.102 26.996l5.253 1.136.422-1.955-5.748-1.243-5.994 1.752 3.424 3.213 1.368-1.459-.87-.817z" />
        ...
        <path d="M19 17a2 2 0 10-4 0 2 2 0 004 0zm2 0a4 4 0 11-8 0 4 4 0 018 0z" />
      </g>
    </svg>
  );
}
