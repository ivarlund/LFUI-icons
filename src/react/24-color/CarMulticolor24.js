...
function CarMulticolor24({ title, titleId, ...props }) {
  return (
    <svg width={24} height={24} aria-labelledby={titleId} {...props}>
      ...
      <g transform="translate(0 2)" fill="none" fillRule="evenodd">
        ...
        <path
          fill="#005AA0"
          fillRule="nonzero"
          d="M14.491 3.951l1.782-.908L18.29 7H7V5h8.026zM2 14v-2h7v2zM15 14v-2h7v2z"
        />
        <path fill="#E30613" fillRule="nonzero" d="M10 14v-2h4v2z" />
        <path
...
export default CarMulticolor24;
