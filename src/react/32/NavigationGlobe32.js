...
function NavigationGlobe32({ title, titleId, ...props }) {
  return (
    <svg width={32} height={32} aria-labelledby={titleId} {...props}>
      {title ? <title id={titleId}>{title}</title> : null}
      <g fill="currentColor" fillRule="nonzero">
        <path d="M9.328 20.86c-3.937-3.938-3.937-10.404 0-14.34L7.913 5.104c-4.717 4.718-4.717 12.45 0 17.169 4.718 4.718 12.451 4.718 17.17 0l-1.415-1.415c-3.937 3.937-10.403 3.937-14.34 0z" />
