  ...
  return (
    <svg width={20} height={20} {...props}>
      <g transform="translate(0 1)" fill="currentColor" fillRule="evenodd">
        ...
        <path
          fillRule="nonzero"
          d="M11.978 5.003l-.396-.916 1.836-.794 1.604 3.71H6v-2zM2 16.003v-2h16v2zM2 13.003v-2h10v2zM13 13.003v-2h5v2zM1 7a1 1 0 110-2h1.5a1 1 0 110 2H1zM17.5 7a1 1 0 010-2H19a1 1 0 010 2h-1.5z"
        />
        <circle cx={5.5} cy={8.75} r={1.25} />
        <circle cx={14.5} cy={8.75} r={1.25} />
        <path
