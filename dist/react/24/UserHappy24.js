...
function UserHappy24({ title, titleId, ...props }) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use
          fill="currentColor"
          fillRule="nonzero"
          xlinkHref="#user-happy-24_svg__a"
